...
class StoreResidentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fourps_status' => ['required', 'string', 'max:100'],
            'date_of_death' => ['nullable', 'date', 'before_or_after:today'],
            'image' => ['nullable', 'image', 'max:2048', 'extensions:jpg,png,jpeg'],
            'disability_status' => ['required', 'string', 'max:100'],
            'disability_type' => ['nullable', 'string', 'max:255'],
            'voter_status' => ['required', 'string', 'max:100'],
            ...
            'booster_status' => ['nullable', 'string', 'max:100'],
            ...
            'name' => ['required', 'string', 'max:255', 'unique:true'],
